...
const MorphingTrigger = () => {
  return (
    <div className="text-grey-90 hover:bg-[#feefdf] active:bg-[#fddcae] active:text-violet-60 focus:border-violet-60 disabled:text-grey-30 bg-transparent disabled:bg-transparent rounded-rounded group relative p-[6px]">
